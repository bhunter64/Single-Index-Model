...
convergence_summary <- data.frame(
  ...
  gamma_prior = scenario_value(results, "gamma_prior"),
  gamma_min_1 = scenario_value(results, "gamma_min_1"),
  gamma_min_2 = scenario_value(results, "gamma_min_2"),
  gamma_max_1 = scenario_value(results, "gamma_max_1"),
  gamma_max_2 = scenario_value(results, "gamma_max_2"),
  gamma_proposal_sd_1 = scenario_value(results, "gamma_proposal_sd_1"),
  gamma_proposal_sd_2 = scenario_value(results, "gamma_proposal_sd_2"),
